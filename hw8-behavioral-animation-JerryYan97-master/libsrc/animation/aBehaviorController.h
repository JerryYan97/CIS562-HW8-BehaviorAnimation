...
// global types
enum BehaviorType { SEEK, FLEE, ARRIVAL, DEPARTURE, AVOID, WANDER, ALIGNMENT, SEPARATION, COHESION, FLOCKING, LEADER, PURSUIT, EVASION, FORMATION };
...
public:
	...
	virtual void display();  // used to help debug behaviors
